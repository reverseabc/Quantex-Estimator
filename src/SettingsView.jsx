...
import { Menu, Settings, Building2, Save, CheckCircle, ShieldAlert, ArrowLeft } from 'lucide-react';
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-30">
        <div className="max-w-5xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button 
              onClick={() => user.onChangeView('dashboard')} 
          ...
          <button 
            onClick={onMenuClick} 
            className="flex items-center gap-2 px-3 py-2 text-slate-600 hover:bg-slate-100 hover:text-[#5ABBCE] rounded-lg transition-colors border border-slate-200 shadow-sm"
          >
            <Menu size={20} />
